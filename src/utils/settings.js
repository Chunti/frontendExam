...
export const BASE_URL = "chunti.dk/backendExam" // <-- replace it with your droplet url so that you can use your database on your droplet instead of local database
